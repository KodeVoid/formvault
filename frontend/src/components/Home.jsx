export default function Home() {
  return (
    <div className="min-h-screen bg-transparent text-white">
      <section id="home" className="relative overflow-hidden z-40">
        <div className="absolute inset-0 bg-black/20"></div>
        
        {/* Hero Section */}
        <div className="relative max-w-7xl mx-auto px-8 py-20">
          <div className="text-center mb-16">
            <div className="inline-flex items-center bg-blue-500/20 border border-blue-500/30 rounded-full px-6 py-3 mb-8">
              <span className="text-blue-300 text-sm font-medium">🔒 Privacy-First Form Handling</span>
            </div>
            
            <h1 className="text-6xl md:text-7xl font-bold mb-8  to-blue-300 bg-clip-text text-white">
              Welcome to FormVault
            </h1>
            
            <p className="text-xl md:text-2xl text-gray-300 max-w-4xl mx-auto mb-12 leading-relaxed">
              The developer-first form handling service with <span className="text-blue-400 font-semibold">zero-knowledge encryption</span> and 
              <span className="text-purple-400 font-semibold"> privacy at its core</span>
            </p>
          ...
          {/* Action Cards */}
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16 z-40">
            <div className="group bg-white/5 backdrop-blur-sm border border-white/10 rounded-xl p-8 hover:bg-white/10 hover:border-white/20 transition-all duration-300 transform hover:scale-105">
              ...
              <a 
                href="#contributions" 
                className="inline-flex items-center bg-gradient-to-r from-green-600 to-emerald-600 hover:from-green-500 hover:to-emerald-500 px-6 py-3 rounded-lg transition-all duration-300 font-medium"
              >
                Get Started
            ...
            <div className="group bg-white/5 backdrop-blur-sm border border-white/10 rounded-xl p-8 hover:bg-white/10 hover:border-white/20 transition-all duration-300 transform hover:scale-105">
              ...
              <a 
                href="#cta" 
                className="inline-flex items-center bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-500 hover:to-purple-500 px-6 py-3 rounded-lg transition-all duration-300 font-medium"
              >
                Sign Up Now
                <svg className="w-4 h-4 ml-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
            ...
            <div className="group bg-white/5 backdrop-blur-sm border border-white/10 rounded-xl p-8 hover:bg-white/10 hover:border-white/20 transition-all duration-300 transform hover:scale-105">
              ...
              <a 
                href="#contact" 
                className="inline-flex items-center bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-500 hover:to-pink-500 px-6 py-3 rounded-lg transition-all duration-300 font-medium"
              >
                Contact Us
                <svg className="w-4 h-4 ml-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
          ...
          {/* Features Preview */}
          <div className=" border border-blue-500/30 rounded-2xl p-12 mb-16">
          ...
          <div id="about" className="text-center mb-16">
            ...
            <div className="max-w-4xl mx-auto">
              <p className="text-lg text-gray-300 mb-8 leading-relaxed">
                ...
                <span className="text-blue-400 font-semibold"> privacy and security</span>. Our zero-knowledge architecture 
                ensures that even we cannot read your users' data without the encryption key.
              </p>
              
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
                <div className="bg-white/5 border border-white/10 rounded-xl p-6">
                  <h4 className="text-xl font-semibold mb-4 text-blue-400">🎯 Our Mission</h4>
                ...
                <div className="bg-white/5 border border-white/10 rounded-xl p-6">
                  <h4 className="text-xl font-semibold mb-4 text-purple-400">🌟 Our Vision</h4>
                  <p className="text-gray-300">
              ...
              <div className=" border border-gray-600/30 rounded-xl p-8">
                <h4 className="text-2xl font-semibold mb-4 text-green-400">Help Shape FormVault's Future</h4>
                <p className="text-gray-300 mb-6">
                ...
                <a
                  ...
                  className="inline-flex items-center bg-gradient-to-r from-green-600 to-teal-600 hover:from-green-500 hover:to-teal-500 px-8 py-4 rounded-xl transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-xl font-semibold"
                >
